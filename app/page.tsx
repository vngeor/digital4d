...
export default async function Home() {
    ...
    const allCategories = productCategories.map(c => ({ id: c.id, slug: c.slug, parentId: c.parentId }))
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 text-white overflow-clip">
            ...
            {heroBanners.length > 0 ? (
                ...
                <section className="relative flex flex-col items-center justify-center text-center py-32 px-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up animation-delay-600">
                        <a href="#services" className="group relative px-8 py-4 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-full font-semibold text-white shadow-lg shadow-emerald-500/25 hover:scale-105 transition-transform">
                            {t("cta1")}
                            <span className="absolute inset-0 rounded-full bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity" />
                        </a>
                        <a href="#contact" className="px-8 py-4 glass rounded-full font-semibold hover:bg-white/10 hover:scale-105 transition-[transform,background-color] duration-200">
                            {t("cta2")}
                        </a>
                    </div>
            ...
            {/* Contact Section */}
            <section id="contact" className="relative py-12 sm:py-24 px-4 z-10 cv-auto">
                <div className="mx-auto max-w-4xl text-center">
                    <h2 className="text-2xl sm:text-4xl font-bold mb-2 sm:mb-4 bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent">
                        {tContact("title")}
                    </h2>
                    ...
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 sm:gap-6">
                        ...
                        <a href="https://wa.me/359888123456" target="_blank" rel="noopener noreferrer"
                           className="group flex flex-col items-center p-3 sm:p-8 rounded-xl sm:rounded-2xl glass hover:bg-white/10 hover:scale-105 transition-[transform,background-color] duration-300">
                            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center mb-2 sm:mb-4 shadow-lg shadow-green-500/30 group-hover:scale-110 transition-transform">
                        ...
                        <a href="viber://chat?number=359888123456" target="_blank" rel="noopener noreferrer"
                           className="group flex flex-col items-center p-3 sm:p-8 rounded-xl sm:rounded-2xl glass hover:bg-white/10 hover:scale-105 transition-[transform,background-color] duration-300">
                            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center mb-2 sm:mb-4 shadow-lg shadow-purple-500/30 group-hover:scale-110 transition-transform">
                                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="mailto:contact@digital4d.bg"
                           className="group flex flex-col items-center p-3 sm:p-8 rounded-xl sm:rounded-2xl glass hover:bg-white/10 hover:scale-105 transition-[transform,background-color] duration-300">
                            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-gradient-to-br from-emerald-400 to-cyan-500 flex items-center justify-center mb-2 sm:mb-4 shadow-lg shadow-emerald-500/30 group-hover:scale-110 transition-transform">
