        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 text-white overflow-hidden">
            ...
            <header className="glass sticky top-0 z-50 border-b border-white/10">
                <div className="mx-auto flex max-w-6xl items-center justify-between p-4">
                    ...
                    <nav className="hidden gap-8 text-sm sm:flex">
                        <a href="#services" className="text-slate-300 hover:text-emerald-400 transition-colors">Услуги</a>
                        <a href="#stl-store" className="text-slate-300 hover:text-emerald-400 transition-colors">STL</a>
                        <a href="#quote" className="text-slate-300 hover:text-emerald-400 transition-colors">Качи файл</a>
                        <a href="#news" className="text-slate-300 hover:text-emerald-400 transition-colors">Новини</a>
                        <a href="#contact" className="text-slate-300 hover:text-emerald-400 transition-colors">Контакт</a>
                    </nav>
            ...
            <section className="relative flex flex-col items-center justify-center text-center py-32 px-4">
                ...
                <p className="max-w-2xl mb-10 text-lg text-slate-300 animate-fade-in-up animation-delay-400">
                    Превръщаме вашите идеи в реалност с висококачествени услуги за 3D печат и моделиране. Бързо, прецизно и достъпно.
                </p>
            ...
            <section id="contact" className="relative py-24 px-4">
                <div className="mx-auto max-w-4xl text-center">
                    ...
                    <p className="text-slate-400 mb-16 text-lg">Свържете се с нас по удобен за вас начин</p>
                    ...
                    <div className="grid gap-6 sm:grid-cols-3">
                        ...
                        <a href="viber://chat?number=359888123456" target="_blank" rel="noopener noreferrer"
                           className="group flex flex-col items-center p-8 rounded-2xl glass hover:bg-white/10 hover:scale-105 hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-300">
                            ...
                            <h3 className="text-xl font-semibold mb-2">Viber</h3>
                            <p className="text-slate-400">+359 888 123 456</p>
                        </a>
            ...
            <footer className="glass border-t border-white/10 py-8 mt-12">
                <div className="mx-auto max-w-6xl px-4 text-center text-slate-400">
                    <p>&copy; 2024 digital4d. Всички права запазени.</p>
                </div>
            </footer>
        </div>
    );
