...
export function TypeForm({
  ...
  const updateField = (field: keyof TypeFormData, value: unknown) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-start sm:items-center justify-center z-50 p-4 pt-2 sm:pt-4">
      <div className="rounded-2xl border border-white/10 w-full max-w-[95vw] sm:max-w-lg max-h-[85svh] flex flex-col bg-[#1a1a2e] shadow-2xl">
          ...
          <div>
            ...
            <div>
              ...
              <input
                ...
                value={
                  formData[
                    `name${activeTab.charAt(0).toUpperCase() + activeTab.slice(1)}` as keyof TypeFormData
                  ] as string
                }
                onChange={(e) =>
                  updateField(
