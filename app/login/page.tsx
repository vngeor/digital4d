                ...
                <div className="glass-strong rounded-3xl p-8 shadow-2xl">
                    ...
                    <div className="space-y-3">
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-xl bg-white text-gray-800 font-semibold hover:bg-gray-100 hover:scale-[1.02] transition-all shadow-lg"
                        >
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-xl bg-[#1877F2] text-white font-semibold hover:bg-[#166FE5] hover:scale-[1.02] transition-all shadow-lg"
                        >
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-xl bg-[#24292F] text-white font-semibold hover:bg-[#1b1f23] hover:scale-[1.02] transition-all shadow-lg"
                        >
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
